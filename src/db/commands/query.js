...
class QueryCommmand extends logic_1.LogicCommand {
...
exports.QueryCommmand = QueryCommmand;
function isQueryCommand(object) {
    return object && (object instanceof QueryCommmand) && (object._internalType === symbol_1.SYMBOL_QUERY_COMMAND);
}
