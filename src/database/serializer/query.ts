...
import { isQueryCommand, isComparisonCommand, QUERY_COMMANDS_LITERAL, QueryCommmand } from '../commands/query'
...
class QueryEncoder {
  ...
  encodeQuery(query: IQueryCondition | QueryCommmand | LogicCommand): IQueryCondition {
  ...
  encodeQueryCommand(query: QueryCommmand): IQueryCondition {
    console.log(query)
  ...
  encodeComparisonCommand(query: QueryCommmand): IQueryCondition {
  ...
  encodeQueryObject(query: IQueryCondition): IQueryCondition {
    let flattened = flattenQueryObject(query)
